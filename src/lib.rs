...
///                     CAN-ID  DLC
/// IVT_Msg_Command     0x411   8       Function commands, SET and GET commands. A command-ID-byte is included for identification
...
/// Capabilities:
/// Decodes data on configured IDs
/// Decodes basic error flags on incoming data.
/// Send query for sensor serial #s.
